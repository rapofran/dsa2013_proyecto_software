<?php include_partial('event/list', array('events' => $pager->getResults())) ?>
 
<?php if ($pager->haveToPaginate()): ?>
  <div class="pagination">
    <a href="<?php echo url_for('event/index') ?>?page=1">
      <img src="/images/first.png" alt="Primer Pagina" title="Primer Pagina" />
    </a>
 
    <a href="<?php echo url_for('event/index') ?>?page=<?php echo $pager->getPreviousPage() ?>">
    ...
    <?php foreach ($pager->getLinks() as $page): ?>
      <?php if ($page == $pager->getPage()): ?>
        <?php echo $page ?>
      <?php else: ?>
        <a href="<?php echo url_for('event/index') ?>?page=<?php echo $page ?>"><?php echo $page ?></a>
      <?php endif; ?>
    <?php endforeach; ?>
 
    <a href="<?php echo url_for('event/index') ?>?page=<?php echo $pager->getNextPage() ?>">
      <img src="/images/next.png" alt="Siguiente Pagina" title="Siguiente Pagina" />
    </a>
 
    <a href="<?php echo url_for('event/index') ?>?page=<?php echo $pager->getLastPage() ?>">
